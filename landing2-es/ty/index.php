	...
	<div class="page-wrapper">
		<div class="main">
				...
				<div class="user-info">
					<div class="user-info_block">
						...
						<div class="user-info__item button">
							<p><span id="edit" class="edit">Editar</span></p>
						</div>
					</div>
			...
			<div class="order-steps">
				<div class="order-steps__item">
					...
					<div class="order-steps__title">
						<p id="step1">Comprueba tus datos de contacto</p>
					</div>
				</div>
				<div class="order-steps__item">
					<div class="order-steps__img">
					...
					<div class="order-steps__title">
						<p id="step2">La llamada puede provenir de un número desconocido</p>
					</div>
				</div>
				<div class="order-steps__item">
					<div class="order-steps__img">
					...
					<div class="order-steps__title">
						<p id="step3">Pago contra reembolso</p>
					</div>
				</div>
			</div>
			...
			<?php if (empty($_POST['email'])) { ?>
				<div class="email">
					<h3 id="email_header">¡Oferta exclusiva!</h3>
					<p id="email_text">¡Recibe ahora mismo tu lista personalizada de recomendaciones!<br />Para ello, deja
						tu <b>correo electrónico</b> en el formulario de abajo.</p>
					<div><input id="email" name="email" type="email" placeholder="email@mail.com" /><span
							id="get">Recibir</span></div>
				</div>
			<?php } ?>
